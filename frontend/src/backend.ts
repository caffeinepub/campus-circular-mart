...
import type { Category as _Category, Listing as _Listing, UserProfile as _UserProfile, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createListing(arg0: string, arg1: string, arg2: number, arg3: Category, arg4: string | null, arg5: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.createListing(arg0, arg1, arg2, to_candid_Category_n10(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n12(this._uploadFile, this._downloadFile, arg4), arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        imageId: record_opt_to_undefined(from_candid_opt_n18(_uploadFile, _downloadFile, value.imageId)),
        price: value.price
    };
}
...
function from_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "clothing" in value ? Category.clothing : "other" in value ? Category.other : "furniture" in value ? Category.furniture : "stationery" in value ? Category.stationery : "textbooks" in value ? Category.textbooks : "electronics" in value ? Category.electronics : value;
}
